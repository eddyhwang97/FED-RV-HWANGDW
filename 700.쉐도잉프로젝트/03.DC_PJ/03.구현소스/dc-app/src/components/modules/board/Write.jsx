      ...
      <table className="dtblview readone">
        ...
        <tbody>
          <tr>
            <td>Name</td>
            <td>
              <input type="text" className="name" size="20" readOnly={true} defaultValue={myCon.loginSts.unm} />
            </td>
          </tr>
          <tr>
            <td>Title</td>
