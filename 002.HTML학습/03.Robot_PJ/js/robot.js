...
function loadFn() {
  ...
  function controlTV() {
    ...
    // 값이 1면 3, 3이면 1로 변경한다.
    scaleValue = scaleValue === "1"?"3":"1";
    // 삼항연산자의 결과가 scalceValue 값을 덮어쓴다!

    let className =
      this.getAttribute("class");

    // 2. 함수호출확인
    console.log("티비틀어!", className, scaleValue, );
    ...
    // -> 왜 인라인라인만? style.속성명=갑 설정을 생각해보면
    // 이것이 인라인 CSS을 설정하는 방법이기 때문
    ...
    switch (className) {
      case "scale":
        ...
        this.title =
          scaleValue === "3"?"축소":"확대";
        break;
      case "ch1" : mv.src = "https://www.youtube.com/embed/RMD91n01DuA?autoplay=1"; break;
      case "ch2" : mv.src = "https://www.youtube.com/embed/a6HoDtEOv7E?autoplay=1"; break;
      case "ch3" : mv.src = "https://www.youtube.com/embed/raPnquNU7Co?autoplay=1";break;
    }
  }////////controlTV 함수 /////////
}; ///loadFn 함수
