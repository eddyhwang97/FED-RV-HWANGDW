...
const myEle3 = (
  <div>
    <h1>리액트는 {num1 * num2}번사용해도 좋다!</h1>
    <h1>리액트는 {num1 == 1000 ? "계속" : "한번만"}번사용해도 좋다!</h1>
    <h1>리액트 {retFn()}</h1>
  </div>
);
// 세번째 div 사용하기
