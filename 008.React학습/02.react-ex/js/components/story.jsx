...
export default function 이야기() {
  // 위에서 컨텍스트를 불러오기 드렁와서 useContext 훜크를 셋팅함
  const 나야나 = React.useContext(누구냐);
  // 불러온 누구냐...를 연결시킨다! 아래ㅉ고에서는
  // 전역으로 사용할 속성/메서드를 나야나...로 쓸수있다!
  ...
  return (
    <div style={나야나.mtBoxCss}>
      {/* 1. 산이름 타이틀 */}
      <h1>
        {<MtIcon mtName={나야나.mtName} />} {나야나.mtName}{" "}
