...
// ->>> 부모인스턴스 영역에서 사용한 부모 data변수인
// ->>>linkdata라는 값이 자식 컴포넌트에서 얽히지 ㅇ낳는다
// ->>> 따라서 이데이터를 프롭스다운 시켜야한다

// [2. 일반적인 컴포넌트 전환방법]
// (1) 앞단코드를 컴포넌트 코드로 넣는다
// (2) 부모영역의 변수를 같은이름의 바인딩 속성으로 만든다
// (3) 컴포넌트에 그 속성을 가져온다

// 예컨데 현재 gnb-comp 에서는..
// 부모 data변수명이 linkData 임
// 따라서 컴포넌트에 프롭스다운 하기위한 속성은 
// v-bind:link-data="linkData"
// 자식 컴포넌트 영역에서 props 항목을 만들고 이것을 넣는다
// props:['link-data'],
// -> 자식컴포넌트안에 코딩된 linkData는 바로 이변수가됨
