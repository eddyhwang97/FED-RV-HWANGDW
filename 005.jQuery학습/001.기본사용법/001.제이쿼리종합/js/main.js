...
$btns
  .first()
  .click(function () {
    //-> 내부화살표함수의 this가 여기에서 걸림!
    //()=>{ //->는 화살표함수는 this가 밖으로 나간다.
