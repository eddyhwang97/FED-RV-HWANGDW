...
//   console.log("시간찍어~!!");
  ...
  // 참고로 getYear()는 1900년도을 뺀 년도가 나옴

  //   (2) 월
  tt[1].innerText =
    today.getMonth() + 1;
  //   tt[1].innerText = monthName[today.getMonth()];
  // 월 정보는 나라마다 부르는 이름이 달라서 순번으로 리턴한다.
  // 그래서 숫자로 출력할때에는 이를 더해준다.
...
console.log("난수*7올림", Math.ceil(rdm));
console.log("난수*7올림", Math.floor(rdm));
...
// 최대수는 8일까?
rdm = Math.random()*9;
console.log("난수*8올림", Math.ceil(rdm));
// 시작수 -1 = 4-1=3
// 3을 더함
